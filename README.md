...
<ul style="font-size: 1.2em; line-height: 1.6;"> 
  <li><b>ch01 - JavaScript 기본 학습:</b> hello.html에서 기본적인 "Hello, World!" 예제입니다.</li><br>
  
  <li><b>ch02 - JavaScript 기초 문법:</b> 변수, 연산자, 조건문, 반복문 등의 기초 문법을 학습합니다.</li><br>
  
  <li><b>ch03 - 함수와 배열:</b> 함수 선언 및 호출, 배열과 내장 함수를 학습합니다.</li> <br>
  
  <li><b>ch04 - 객체와 브라우저 객체 모델:</b> 사용자 정의 객체와 내장 객체, DOM 및 BOM을 학습합니다.</li> <br>
  
  <li><b>ch05 - 이벤트 처리:</b> 다양한 이벤트 리스너와 이벤트 전파 방식을 학습합니다.</li><br>
  
  <li><b>ch06 - 비동기 처리:</b> 비동기 함수, Promise, JSON 데이터 처리를 학습합니다.</li><br>
  
  <li><b>todoApp - 간단한 프로젝트:</b> JavaScript를 활용한 간단한 To-Do List 애플리케이션입니다.</li> <br>
